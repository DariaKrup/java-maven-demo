...
object Build : BuildType({
    ...
    params {
        text("text_parameter", "text_value", label = "Text", description = "Text Parameter", allowEmpty = true)
        ...
        hashiCorpVaultParameter {
            ...
            vaultId = "Vault"
            param("buildTypeId", "RemoteGitProjectWithEnabledDsl_Build")
        }
    }
